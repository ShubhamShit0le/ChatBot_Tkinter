...
# os.environ["OPENAI_API_KEY"] = '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'
...
# response_text = Text(root, wrap=tk.WORD, width=50, height=20)
# response_text.pack()
...
#     if query:
#         response = ask_bot(query)  # Call ask_bot with user's query
...
# # Create a "Send" button to trigger the query
# send_button = tk.Button(root, text="Send", command=get_user_query)
# send_button.pack()
...
#Desktop Application (ChatBot) Using Tinkter
...
#                 entry_user_input.insert(0, "Enter Y-coordinate")  # Prompt for Y-coordinate
#             except ValueError:
...
#                 ao = skyciv.ApiObject()
#                 ao.auth.username = "nilay.ram@skyciv.com"
#                 ao.auth.key = "v1tMCV5J4TQ5mEojrSN7N8fWNyRbfeNmwBBuax6JhTdU2udr4I4nhoAIxtMxIgLQ"
...
#                 y_coord = None
#                 entry_user_input.delete(0, tk.END)
#                 entry_user_input.insert(0, "Enter your message")  # Reset input prompt
#                 waiting_for_coordinates = False
#             else:
...
#             entry_user_input.delete(0, tk.END)
#             entry_user_input.insert(0, "Enter Z-coordinate")  # Prompt for Z-coordinate
#         else:
...
# # Create a Text widget for displaying bot responses
# response_text = Text(root, wrap=tk.WORD, width=80, height=30)
# response_text.pack()
